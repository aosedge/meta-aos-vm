...
1. Start Bosch demo VM and provision the unit:
   https://github.com/aosedge/meta-aos-vm/releases/download/v6.1.0-bosch.2/aos-vm-image-genericx86-64-6.1.1-bosch.2.tar.xz
...
3. Deploy the required Aos layers to the AosCloud:
   ...
   * download the require layers:
     https://github.com/aosedge/meta-aos-vm/releases/download/v6.1.1-bosch.2/aos-vm-layers-genericx86-64-6.1.1-bosch.2.tar.gz
