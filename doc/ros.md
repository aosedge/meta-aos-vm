...
Suggested to remove all these generated folders to perform a clean build of the workspace.
...
the ROS_HOME env variable value which is likely to lead to service failure
